...
| T09 | Boucle native et MCP vérifiés avec fournisseur de test ; Astra à raccorder | Agent restreint à cinq outils, historique transmis, proposition et réponse tardives écartées. Commande réelle ARDY et retransmission vérifiées séparément. Hôte conversationnel à terminer. Accès OpenAI essayé : HTTP 401. [Configuration et limites](hermes-setup.md) |
