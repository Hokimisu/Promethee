...
| T11 | Diagnostic vocal et comptes rendus persistants implémentés ; audio réel à qualifier | Micro à la demande → même Hermes → synthèse. Migration v11 ; lecture interrompue distinguée du texte généré. Astra réel reconnaît l'incertitude des mots entendus à partir d'un compte rendu simulé. 371 tests passent. Aucun microphone ni fournisseur audio réel validé ; GPT-Live reste à raccorder. [Mode et limites](voice.md) |
